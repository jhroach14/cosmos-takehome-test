...
#
# Expected Behavior:
#   - TEMPERATURES_STATE should reflect that the worst-state _TEMP telemetry item is RED
#   - VOLTAGES_STATE should reflect that the worst-state _VOLTAGE telemetry item is RED
...
inject_tlm( "HEALTH_MONITOR",
            "STATE_OF_HEALTH",
            {
                ...
                "CAMERA_TEMP" => CAMERA_TEMP_RED,
                "BATTERY_STACK_TEMP" => BATTERY_STACK_TEMP_YELLOW,
                "RADIO_TEMP" => RADIO_TEMP_GREEN,
                "CAMERA_VOLTAGE" => CAMERA_VOLTAGE_RED,
                "BATTERY_STACK_VOLTAGE" => BATTERY_STACK_VOLTAGE_YELLOW,
                "RADIO_VOLTAGE" => RADIO_TEMP_GREEN,
                "CAMERA_CURRENT" => CAMERA_CURRENT_RED,
                "BATTERY_STACK_CURRENT" => BATTERY_STACK_CURRENT_YELLOW,
                "RADIO_CURRENT" => RADIO_CURRENT_GREEN,
            })
