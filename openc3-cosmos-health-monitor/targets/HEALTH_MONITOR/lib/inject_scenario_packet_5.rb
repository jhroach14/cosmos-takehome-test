...
#
# Expected Behavior:
#   - TEMPERATURES_STATE should reflect that the worst-state _TEMP telemetry item is YELLOW
#   - VOLTAGES_STATE should reflect that the worst-state _VOLTAGE telemetry item is YELLOW
#   - CURRENTS_STATE should reflect that the worst-state _CURRENT telemetry item is YELLOW
...
inject_tlm( "HEALTH_MONITOR",
            "STATE_OF_HEALTH",
            {
                ...
                "RADIO_TEMP" => RADIO_TEMP_YELLOW,
                "CAMERA_VOLTAGE" => CAMERA_VOLTAGE_YELLOW,
                "BATTERY_STACK_VOLTAGE" => BATTERY_STACK_VOLTAGE_YELLOW,
                "RADIO_VOLTAGE" => RADIO_VOLTAGE_YELLOW,
                "CAMERA_CURRENT" => CAMERA_CURRENT_YELLOW,
                "BATTERY_STACK_CURRENT" => BATTERY_STACK_CURRENT_GREEN,
                "RADIO_CURRENT" => RADIO_CURRENT_YELLOW,
            })
