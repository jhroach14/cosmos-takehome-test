...
#   - VOLTAGES_STATE should reflect that the worst-state _VOLTAGE telemetry item is GREEN
#   - CURRENTS_STATE should reflect that the worst-state _CURRENT telemetry item is GREEN
...
inject_tlm( "HEALTH_MONITOR",
            "STATE_OF_HEALTH",
            {
                ...
                "BATTERY_STACK_VOLTAGE" => BATTERY_STACK_VOLTAGE_GREEN,
                "RADIO_VOLTAGE" => RADIO_VOLTAGE_GREEN,
                "CAMERA_CURRENT" => CAMERA_CURRENT_GREEN,
                "BATTERY_STACK_CURRENT" => BATTERY_STACK_CURRENT_GREEN,
